  ...
  <div class="col-1-3 col-location">
    <div class="location">
      ...
      <div class="location-wrap">
        ...
        Chicago, IL 60607<br>
        (312) 879-7499</p>
        <p class="time">Ceremony starts at 6:00 PM</p>
        <ul>
          <li><a href="https://www.google.com/maps/dir/''/prairie+production/@41.8846069,-87.6938698,13z/data=!3m1!4b1!4m8!4m7!1m0!1m5!1m1!1s0x880e2d27960cfadb:0x5d4b65d647d72319!2m2!1d-87.659537!2d41.884612" class="btn">Directions</a></li>
          <li><a href="http://www.prairieproduction.net" class="btn">Website</a></li>
        </ul>
      </div>
    </div>
  </div>
  
  <div class="col-1-3 col-reserve">
    ...
    <div class="reserved">
      ...
      <div class="main-hotel">
        ...
        Chicago, IL 60601<br>
        (312) 236-0123</p>
        <p><a href="https://gc.synxis.com/rez.aspx?Hotel=26719&Chain=10179&arrive=11/6/2014&depart=11/7/2014&adult=1&child=0&promo=WEDBLN" class="btn">Book a Room</a></p>
      </div>
    </div>
    ...
    <div class="options">
      ...
      <ul>
        <li>
          <p class="label">Normalest</p>
          <p class="location"><a href="http://www.sheratonchicago.com/">Sheraton</a>
        </li>
        <li>
          <p class="label">Most Unique</p>
          <p class="location"><a href="https://www.airbnb.com/">AirBnB</a></p>
        </li>
        <li>
          <p class="label">Trendiest</p>
          <p class="location"><a href="http://www.longmanandeagle.com/sleep/">Longman &amp; Eagle</a></p>
        </li>
        <li>
          <p class="label">Cheapest</p>
          <p class="location"><a href="http://holidayjones.com/">Holiday Jones</a>
        </li>
      </ul>
    </div>
